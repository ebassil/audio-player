...
This spec defines the plugin popup window that provides a resizeable interface for managing plugins, including listing, enabling/disabling, reordering, and displaying plugin GUI iframes.
