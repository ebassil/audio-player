...
Tracks the actual playback position (frames consumed from the ring buffer by the audio callback) independently from the decode-side position, enabling accurate transition trigger timing.
