...
This spec defines the StreamingDecoder component that provides incremental audio decoding, enabling low-latency playback start and efficient memory usage for large audio files.
